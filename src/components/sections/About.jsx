...
const About = () => {
  ...
  return (
    <section
      id="about"
      className="relative min-h-[80vh] flex items-center py-20 bg-black overflow-hidden"
    >
          ...
          <FadeIn delay={200}>
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="relative group">
                <div className="absolute inset-0 bg-linear-to-br from-primary/10 to-primary/5 rounded-2xl blur-xl opacity-50 group-hover:opacity-75 transition-opacity duration-300"></div>
                <div className="relative overflow-hidden rounded-2xl border border-emerald-400/20 bg-emerald-500/10 p-6 shadow-[0_0_30px_rgba(16,185,129,0.12)] hover:border-emerald-300/40 transition-all duration-300 h-full">
